...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FilterModal_LP", function() { return FilterModal_LP; });
...
let FilterModal_LP = class FilterModal_LP {
    constructor(service, lpservice, locationService, modalCrtl, translate, statusBar, modalCtrl, geolocation, nativeGeocoder, alertController) {
    ...
    iniFilter() {
        if (!_GlobalFieldsListingPro__WEBPACK_IMPORTED_MODULE_12__["GlobalFieldsListingPro"].filtersSearch) {
            ...
            /* if (GlobalFieldsListingPro.filtersSearch.tags.length == 0)
               this.prepareOptionsTags();*/
            if (_GlobalFieldsListingPro__WEBPACK_IMPORTED_MODULE_12__["GlobalFieldsListingPro"].filtersSearch.features.length == 0)
                this.prepareOptionsFeatures();
    ...
    prepareOptionsFeatures() {
        _GlobalFieldsListingPro__WEBPACK_IMPORTED_MODULE_12__["GlobalFieldsListingPro"].features.forEach(cat => {
            if (cat.count > 0) {
                let c = new _entities_checkboxType__WEBPACK_IMPORTED_MODULE_3__["CheckboxType"]();
                c.isChecked = false;
                c.val = cat;
...
FilterModal_LP = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'page-filter',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./filterModal_LP.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/ListingPro/searchPage/filterModal/filterModal_LP.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./filterModal_LP.scss */ "./src/app/ListingPro/searchPage/filterModal/filterModal_LP.scss")).default]
    }),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MapModal_LP", function() { return MapModal_LP; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _GlobalFields__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../GlobalFields */ "./src/app/GlobalFields.ts");
...
/* harmony import */ var _filterModal_filterModal_LP__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../filterModal/filterModal_LP */ "./src/app/ListingPro/searchPage/filterModal/filterModal_LP.ts");
...
/* harmony import */ var _services_MyListingService__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../../services/MyListingService */ "./src/app/services/MyListingService.ts");
/* harmony import */ var _listingPage_listing_page_LP_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../listingPage/listing-page_LP.component */ "./src/app/ListingPro/listingPage/listing-page_LP.component.ts");
/* harmony import */ var _services_ListingProService__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../../services/ListingProService */ "./src/app/services/ListingProService.ts");
/* harmony import */ var _GlobalFieldsListingPro__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../../../GlobalFieldsListingPro */ "./src/app/GlobalFieldsListingPro.ts");
...
let MapModal_LP = class MapModal_LP {
    constructor(service, lpservice, mlservice, modalCtrl, locationService, alertController) {
        this.service = service;
        this.lpservice = lpservice;
    ...
    getPositions() {
        ...
        let listings = [];
        if (!this.GlobalFields.site_details.showMapAllListings)
            listings = _GlobalFieldsListingPro__WEBPACK_IMPORTED_MODULE_12__["GlobalFieldsListingPro"].filteredListings;
        else
            ...
            if (listing.post_meta) {
                ...
                //Compute lat and long from gAddress
                    ...
                    if (_GlobalFields__WEBPACK_IMPORTED_MODULE_2__["GlobalFields"].site_details.mapType == 1) {
                        this.locationService.getMyLatLongFromGoogle(listing.post_meta.gAddress).subscribe((data) => {
                        ...
                        this.locationService.getLatLongFromOpenMaps(listing.post_meta.gAddress).subscribe((data) => {
                            console.log(data);
    ...
    endOfComputeAddresses(totals, current) {
        console.log(totals);
        console.log(current);
        if (totals == current) {
    ...
    createPosition(listing, lat, long) {
        let imgUrl = '';
    ...
    getPositionsOSMaps() {
        ...
        const customMarkerIcon = Object(leaflet__WEBPACK_IMPORTED_MODULE_7__["icon"])({
            iconUrl: '../../assets/imgs/placeholder_location.png',
            iconSize: [64, 64],
            popupAnchor: [0, -20]
        });
        let makerToOpen;
        let markers = new leaflet__WEBPACK_IMPORTED_MODULE_7__["MarkerClusterGroup"]();
        for (let i = 0; i < this.positions.length; i++) {
            ...
            //Custom icon
            let defaultIcon = Object(leaflet__WEBPACK_IMPORTED_MODULE_7__["divIcon"])({
            ...
            const m = Object(leaflet__WEBPACK_IMPORTED_MODULE_7__["marker"])([pos.lat, pos.lng], { icon: defaultIcon });
            let address = '';
...
MapModal_LP = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'map-filter',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./mapModal_LP.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/ListingPro/searchPage/mapModal/mapModal_LP.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./mapModal_LP.scss */ "./src/app/ListingPro/searchPage/mapModal/mapModal_LP.scss")).default]
    }),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_services_Service__WEBPACK_IMPORTED_MODULE_3__["Service"], _services_ListingProService__WEBPACK_IMPORTED_MODULE_11__["ListingProService"], _services_MyListingService__WEBPACK_IMPORTED_MODULE_9__["MyListingService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["ModalController"], _services_LocationService__WEBPACK_IMPORTED_MODULE_6__["LocationService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["AlertController"]])
], MapModal_LP);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SearchPage_LP", function() { return SearchPage_LP; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
...
/* harmony import */ var _filterModal_filterModal_LP__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./filterModal/filterModal_LP */ "./src/app/ListingPro/searchPage/filterModal/filterModal_LP.ts");
...
/* harmony import */ var _mapModal_mapModal_LP__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./mapModal/mapModal_LP */ "./src/app/ListingPro/searchPage/mapModal/mapModal_LP.ts");
...
/* harmony import */ var _listingPage_listing_page_LP_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../listingPage/listing-page_LP.component */ "./src/app/ListingPro/listingPage/listing-page_LP.component.ts");
/* harmony import */ var _GlobalFieldsListingPro__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../../GlobalFieldsListingPro */ "./src/app/GlobalFieldsListingPro.ts");
/* harmony import */ var _services_ListingProService__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../../services/ListingProService */ "./src/app/services/ListingProService.ts");
...
let SearchPage_LP = class SearchPage_LP {
    constructor(service, lpservice, mlservice, locationService, modalCtrl, statusBar, platform, translate, alertController) {
        this.service = service;
        this.lpservice = lpservice;
        this.mlservice = mlservice;
        this.locationService = locationService;
    ...
    loadData() {
        ...
        if (_GlobalFieldsListingPro__WEBPACK_IMPORTED_MODULE_12__["GlobalFieldsListingPro"].filtersSearch.location) { //address
            //Convert address to Lat and Lng
            if (_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].site_details.mapType == 1) {
                this.locationService.getMyLatLongFromGoogle(_GlobalFieldsListingPro__WEBPACK_IMPORTED_MODULE_12__["GlobalFieldsListingPro"].filtersSearch.location).subscribe((data) => {
                    if (data.results && data.results.length > 0 && data.results[0].geometry && data.results[0].geometry.location) {
                ...
                this.locationService.getLatLongFromOpenMaps(_GlobalFieldsListingPro__WEBPACK_IMPORTED_MODULE_12__["GlobalFieldsListingPro"].filtersSearch.location).subscribe((data) => {
                    console.log(data);
                    if (data && data.length > 0) {
    ...
    initialCall(reloadOrder) {
        ...
        const setLocation = _GlobalFieldsListingPro__WEBPACK_IMPORTED_MODULE_12__["GlobalFieldsListingPro"].filtersSearch.location;
        _GlobalFieldsListingPro__WEBPACK_IMPORTED_MODULE_12__["GlobalFieldsListingPro"].clearFilters();
        if (setLocation)
            _GlobalFieldsListingPro__WEBPACK_IMPORTED_MODULE_12__["GlobalFieldsListingPro"].filtersSearch.location = setLocation;
    ...
    callServiceToGetFilteredListings() {
        this.lpservice.getFilteredListings()
            ...
            if (_GlobalFieldsListingPro__WEBPACK_IMPORTED_MODULE_12__["GlobalFieldsListingPro"].filtersSearch.currentPage == 0) {
                _GlobalFieldsListingPro__WEBPACK_IMPORTED_MODULE_12__["GlobalFieldsListingPro"].filteredListings = [];
...
], SearchPage_LP.prototype, "infiniteScroll", void 0);
SearchPage_LP = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'page-search',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./searchPage_LP.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/ListingPro/searchPage/searchPage_LP.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./searchPage_LP.scss */ "./src/app/ListingPro/searchPage/searchPage_LP.scss")).default]
    }),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SearchPage_LPModule", function() { return SearchPage_LPModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
...
/* harmony import */ var _searchPage_LP__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./searchPage_LP */ "./src/app/ListingPro/searchPage/searchPage_LP.ts");
...
/* harmony import */ var _mapModal_mapModal_LP__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./mapModal/mapModal_LP */ "./src/app/ListingPro/searchPage/mapModal/mapModal_LP.ts");
...
/* harmony import */ var _shared_LP_module__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../shared_LP.module */ "./src/app/ListingPro/shared_LP.module.ts");
/* harmony import */ var _filterModal_filterModal_LP__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./filterModal/filterModal_LP */ "./src/app/ListingPro/searchPage/filterModal/filterModal_LP.ts");
...
let SearchPage_LPModule = class SearchPage_LPModule {
};
SearchPage_LPModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_5__["NgModule"])({
        imports: [
            ...
            _shared_LP_module__WEBPACK_IMPORTED_MODULE_10__["SharedModule_LP"],
        ],
...
//# sourceMappingURL=ListingPro-searchPage-search_LP-module-es2015.js.map