export class Config {
  ...
  themeEnabled?: string; //"listing-pro", "my-listing"

  appName?: string;
  customPageUrl?: string; // it's an id
  homeType?: number = 1; // 1: AirBnb style, 2: MylistingStyle/ListingPro , 3: TripAdvisor
  disableMap?: boolean;
  language?: string;
  ...
  lpHomeBackUrl?: string; //Used only for ListingPro and only for ListingPro home style
